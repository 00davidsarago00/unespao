...
|---|---|---|---|
| T1 | **Do assistente ao agente.** A duração das tarefas que agentes completam sozinhos com 50% de confiabilidade dobra a cada **~7 meses** há 6 anos | METR [F-18] (os autores estimam de 1 a 4 dobras por ano); 79% de automação no Claude Code [F-32]. **Limitação:** são tarefas autocontidas e de pontuação automática — o mesmo abismo que derrubou o SWE-bench (`05` §5.7) | Fraco (extrapolação) |
