...
- 44 fontes externas registradas, 8 aulas mapeadas e 7 evidências do repositório.
- **Validação (GP-01) concluída em 2026-09-17:** 43 das 44 fontes estão conferidas na origem (**P**).
  A exceção é F-11 (página da OpenAI responde HTTP 403), conferida em cobertura secundária e assim
  marcada no texto.
- **Lacunas conhecidas:**
