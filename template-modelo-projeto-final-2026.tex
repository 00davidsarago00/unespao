...
\newcommand{\projsubtitle}{Documentação do Projeto de Software (A PREENCHER PELO GRUPO -- subtítulo)}
...
\begin{titlepage}
	...
	David Almeida Saragó -- RA: (A PREENCHER PELO GRUPO)\\[2mm]
	Guilherme Molina Trindade -- RA: (A PREENCHER PELO GRUPO)\\[2mm]
	Lucas Costa Oliveira -- RA: (A PREENCHER PELO GRUPO)\\[2mm]
	Thiago Mitsuo Nomura da Silva -- RA: (A PREENCHER PELO GRUPO)
...
\begin{tabularx}{0.95\textwidth}{p{0.24\textwidth} p{0.10\textwidth} X}
\toprule
...
\bigskip
\noindent\textit{Dados de capa (RA dos integrantes, subtítulo do software, data de entrega): (A PREENCHER PELO GRUPO).}
...
(A PREENCHER PELO GRUPO) & Equipe Unespão & 1.0 & Versão consolidada para entrega, com revisão geral do conteúdo de todos os capítulos e ajustes finais de redação e formatação. \\
\bottomrule
\end{tabularx}
\end{table}
