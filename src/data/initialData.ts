import { ProdutoBase, Ingrediente, SugestaoPersonalizada, Pedido, ArchitectureDiagram, Padaria, ReviewOnline } from '../types';

export const INITIAL_BAKERIES: Padaria[] = [
  {
    id: 'padaria-1',
    nome: 'Padaria Central Unesp',
    distanciaKm: 0.4,
    tempoMin: '15-20 min',
    nota: 4.9,
    avaliacoesQtd: 142,
    endereco: 'Av. Eng. Luiz Edmundo Carrijo Coube, 14-01 (Em frente ao Bloco Central)',
    icone: '🥖',
    destaque: 'Fornadas de pão francês a cada 20 min e chapa rápida para universitários',
    taxaEntrega: 0,
    produtosDisponiveisIds: ['base-1', 'base-2', 'base-3', 'base-4', 'base-5', 'base-6'],
    aberta: true,
    horarioFuncionamento: 'Seg a Sex: 06:30 - 21:30 • Sáb: 07:00 - 18:00',
  },
  {
    id: 'padaria-2',
    nome: 'Cantina & Padaria da Geologia',
    distanciaKm: 0.2,
    tempoMin: '10-15 min',
    nota: 4.9,
    avaliacoesQtd: 210,
    endereco: 'Campus UNESP Bauru - Bloco de Geociências e Ciências Exatas',
    icone: '🥯',
    destaque: 'Ponto clássico da UNESP com pães na chapa, café artesanal e molhos caseiros',
    taxaEntrega: 0,
    produtosDisponiveisIds: ['base-1', 'base-2', 'base-3', 'base-5'],
    aberta: true,
    horarioFuncionamento: 'Seg a Sex: 07:15 - 19:30',
  },
  {
    id: 'padaria-3',
    nome: 'Panificadora Trigo Dourado Bauru',
    distanciaKm: 0.9,
    tempoMin: '20-30 min',
    nota: 4.8,
    avaliacoesQtd: 98,
    endereco: 'Rua Eng. Saint Martin, 18-45 - Vila Universitária',
    icone: '🥐',
    destaque: 'Especialista em Ciabattas de fermentação natural e queijo da Canastra derretido',
    taxaEntrega: 3.5,
    produtosDisponiveisIds: ['base-1', 'base-2', 'base-3', 'base-4', 'base-6'],
    aberta: true,
    horarioFuncionamento: 'Todos os dias: 06:00 - 22:00',
  },
  {
    id: 'padaria-4',
    nome: 'Forno & Grãos da Vila',
    distanciaKm: 1.4,
    tempoMin: '25-35 min',
    nota: 4.7,
    avaliacoesQtd: 76,
    endereco: 'Av. Nações Unidas, 22-10 - Próximo ao Hospital Estadual',
    icone: '🥪',
    destaque: 'Pães integrais multigrãos 7 grãos e bowls de salada fresca montados na hora',
    taxaEntrega: 4.0,
    produtosDisponiveisIds: ['base-2', 'base-4', 'base-5'],
    aberta: true,
    horarioFuncionamento: 'Seg a Sáb: 06:30 - 20:30',
  },
];
...
export const INITIAL_REVIEWS: ReviewOnline[] = [
  {
    ...
    autorCargoOuCurso: 'Ciência da Computação • UNESP',
    nota: 5,
    data: 'Hoje às 18:45',
  ...
  },
  {
    ...
    autorCargoOuCurso: 'Design Gráfico • UNESP',
    nota: 5,
    data: 'Ontem',
  ...
  },
  {
    id: 'rev-3',
    padariaId: 'padaria-2',
    autorNome: 'Prof. Marcos Vinícius',
    autorCargoOuCurso: 'Engenharia Elétrica • UNESP',
    nota: 4,
    data: 'Há 2 dias',
    comentario: 'Atendimento muito ágil pelo sistema do Unespão. Acompanhar a fila e só ir buscar quando o pão estiver pronto evita filas enormes de manhã no campus.',
  ...
  },
  {
    ...
    autorCargoOuCurso: 'Sistemas de Informação • UNESP',
    nota: 5,
    data: 'Há 4 dias',
...
export const INITIAL_ORDERS: Pedido[] = [
  {
    ...
    canal: 'app_mobile',
    clienteNome: 'Gabriel Santos (Aluno UNESP)',
    clienteEmail: 'gabriel.santos@unesp.br',
    valorTotal: 26.50,
  ...
  },
  {
    ...
    codigo: 'UNESP-103',
    padariaId: 'padaria-2',
    padariaNome: 'Cantina & Padaria da Geologia',
    canal: 'app_mobile',
    clienteNome: 'Mariana Souza (Geologia)',
    clienteEmail: 'mariana.souza@unesp.br',
    valorTotal: 33.20,
    status: 'em_preparo',
    metodoPagamento: 'pix',
    criadoEm: 'Há 8 min',
...
export const ARCHITECTURE_DIAGRAMS: ArchitectureDiagram[] = [
  ...
  },
  {
    ...
    nivel: 'Padrão de Projeto Estrutural',
    arquivo: '/images/padrao-decorator-sanduiche.svg',
    descricao: 'Estrutura Component / ConcreteComponent / Decorator / ConcreteDecorator: IItemPersonalizavel implementada por ProdutoBase e decorada dinamicamente por IngredienteDecorator (QueijoDecorator, BaconDecorator etc.), eliminando explosão combinatória de subclasses e permitindo recálculo de preço incremental em tempo de execução.',
